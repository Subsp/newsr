...
def generate_random_blender_pcd(ply_path, num_pts=100_000):
...
def readNerfSyntheticInfo(path, white_background, eval, extension=".png"):
    ...
    pcd = None
    if not os.path.exists(ply_path):
        pcd = generate_random_blender_pcd(ply_path)
    try:
        pcd = fetchPly(ply_path)
    except Exception:
        # Corrupted/partial points3d.ply can appear on interrupted runs.
        pcd = generate_random_blender_pcd(ply_path)
