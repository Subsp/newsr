...
__device__ inline glm::vec3 dilateCov2D(const glm::mat3 cov, const bool proper_ewa_scaling, const float kernel_size, float& det_dilated, float& convolution_scaling_factor)
{
...
__device__ void computeCov3D(const glm::vec3 scale, const float mod, const glm::vec4 rot, float* cov3D)
{
