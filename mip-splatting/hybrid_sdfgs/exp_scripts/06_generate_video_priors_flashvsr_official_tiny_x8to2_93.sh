...
OUTPUT_ROOT="/root/autodl-tmp/priors/kitchen_video_flashvsr_official_tiny_x8to2_93"
...
echo "[generate-video-prior-flashvsr-official-tiny-x8to2-93] done: ${OUTPUT_ROOT}/priors"
