...
DEPLOY_SELECTOR_FAMILY="${DEPLOY_SELECTOR_FAMILY:-A}"
DEPLOY_SELECTOR_RANK_KEY="${DEPLOY_SELECTOR_RANK_KEY:-C_selection_gain}"
DEPLOY_SELECTOR_TOP_K="${DEPLOY_SELECTOR_TOP_K:-40}"
DEPLOY_SELECTOR_MIN_RANK_VALUE="${DEPLOY_SELECTOR_MIN_RANK_VALUE:--inf}"
...
ARGS=(
  ...
  --deploy_selector_family "${DEPLOY_SELECTOR_FAMILY}"
  --deploy_selector_rank_key "${DEPLOY_SELECTOR_RANK_KEY}"
  --deploy_selector_top_k "${DEPLOY_SELECTOR_TOP_K}"
  "--deploy_selector_min_rank_value=${DEPLOY_SELECTOR_MIN_RANK_VALUE}"
...
cp "${OUTPUT_DIR}/deploy_selected_rows.json" "${CHECK_DIR}/deploy_selected_rows.json"
cp "${OUTPUT_DIR}/core_selected_rows.json" "${CHECK_DIR}/core_selected_rows.json"
...
echo "  ${CHECK_DIR}/deploy_selected_rows.json"
echo "  ${CHECK_DIR}/core_selected_rows.json"
