...
EFFECTIVE_SCORE_THRESHOLD="${EFFECTIVE_SCORE_THRESHOLD:-0.13}"
EFFECTIVE_TEXTURE_WEIGHT="${EFFECTIVE_TEXTURE_WEIGHT:-0.85}"
EFFECTIVE_MIN_COHERENCE="${EFFECTIVE_MIN_COHERENCE:-0.22}"
EFFECTIVE_NOISE_SUPPRESSION="${EFFECTIVE_NOISE_SUPPRESSION:-0.80}"
EFFECTIVE_CONTEXT_FLOOR="${EFFECTIVE_CONTEXT_FLOOR:-0.20}"
...
ARGS=(
  ...
  --effective_texture_weight "${EFFECTIVE_TEXTURE_WEIGHT}"
  --effective_min_coherence "${EFFECTIVE_MIN_COHERENCE}"
  --effective_noise_suppression "${EFFECTIVE_NOISE_SUPPRESSION}"
  --effective_context_floor "${EFFECTIVE_CONTEXT_FLOOR}"
...
echo "  ${OUTPUT_ROOT}/effective_hf_carrier_rgb"
echo "  ${OUTPUT_ROOT}/geometry_weight"
echo "  ${OUTPUT_ROOT}/texture_weight"
echo "  ${OUTPUT_ROOT}/noise_weight"
echo "  ${OUTPUT_ROOT}/effective_hf_weight"
echo "  ${OUTPUT_ROOT}/effective_hf_score"
