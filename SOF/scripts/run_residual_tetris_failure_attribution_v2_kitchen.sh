...
PER_CELL_SHIFT_GRID="${PER_CELL_SHIFT_GRID:-}"
...
echo "  ${CHECK_DIR}/shift_attribution_report.json"
echo "  ${CHECK_DIR}/alignment_sanity_report.json"
echo "  ${CHECK_DIR}/qtrue_status_or_qtrue_metrics.json"
